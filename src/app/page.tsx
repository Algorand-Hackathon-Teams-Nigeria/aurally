...
import { NftCarouselLoader } from "./component/NftCarousel";
...
export default function LandingPage({ searchParams }: PageProp) {
  ...
  return (
    <main
      className={`${classes.landing} max-h-screen font-space overflow-y-auto px-[4.5%] bg-pageGrad`}
    >
      <div className="max-w-6xl mx-auto">
        ...
        <nav className="pt-6 pb-3 flex justify-between items-center">
          ...
          <SideBar />
          <Link href="https://dapp.aurally.xyz" className={`${classes.getBtn} hidden lg:flex`}>
            Launch App
          </Link>
        </nav>
        {/* Hero Section */}
        ...
        <div className="mb-36" id="road">
          ...
          <div className="hidden md:block">
            <div className="grid grid-cols-roadmap items-center">
              <div className="pt-14" />
              <div className={`h-full bg-primary relative ${classes.roadmap_top}`} />
            </div>
            ...
            <div className="grid grid-cols-roadmap items-center">
              <div className="pb-14" />
              <div className={`h-full bg-primary relative ${classes.roadmap_bottom}`} />
            </div>
          </div>
