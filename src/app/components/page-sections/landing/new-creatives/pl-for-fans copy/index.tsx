...
const HeroButtons = ({
  ...
  <div className="flex flex-col gap-2.5 mt-8 sm:ml-[-65px] ml-0 sm:mr-0 mr-4 w-full max-w-[500px] mx-auto translate-y-[20px] 2xl:translate-x-[170px] lg:translate-x-[0px]">
