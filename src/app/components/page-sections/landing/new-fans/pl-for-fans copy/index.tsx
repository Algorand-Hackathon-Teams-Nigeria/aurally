...
const HeroText = ({
	...
	<div className="hero-text-container sm:ml-40 text-center sm:text-left lg:translate-y-[100px] mx-auto">
		<h1 className="leading-[110%] font-bold text-4xl sm:text-4xl max-w-[635px] mx-auto sm:mx-0 sm:mt-[-330px] translate-y-[20px] lg:translate-x-0 translate-x-[10px]">
		...
		<p className="hero-subtitle mt-2 mx-auto sm:mx-0 translate-y-[20px] lg:translate-x-0 translate-x-[10px]">
			{subtitle}
		</p>
	</div>
);
...
const HomePage = () => (
	<div className="h-screen">
		...
		<main
			className="grid grid-cols-12 gap-8 px-4 pt-16 sm:pt-[200px] bg-cover bg-center h-screen sm:min-h-[calc(100vh+100px)]"
		...
		>
			...
			>
				...
				<Image
					...
					width={300}
					height={600}
					className="w-80 md:w-96 lg:w-full max-h-[55vh] object-contain z-10"
				/>
			</div>

			{/* Embla Carousel and Buttons for Desktop */}
			<div className="col-span-12 flex flex-col justify-center items-start sm:mt-8 ">
				<div className="flex flex-row gap-6 mt-[-530px] sm:mt-[-1170px]">
					<div
						key="carousel"
						className="flex flex-col gap-4 w-full opacity-30 lg:mb-[-530px]"
					>
						<EmblaCarousel />
					</div>
				</div>
