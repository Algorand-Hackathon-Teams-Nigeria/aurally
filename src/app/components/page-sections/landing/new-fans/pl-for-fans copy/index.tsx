...
const HeroText = ({
  ...
  <div className="hero-text-container sm:ml-40 text-center sm:text-left lg:translate-y-[100px] mx-auto">
    <h1
      className="leading-[110%] font-bold text-4xl sm:text-4xl max-w-[635px] mx-auto sm:mx-0 sm:mt-[-330px] translate-y-[20px] lg:translate-x-0 translate-x-[10px]"
    >
    ...
    <p className="hero-subtitle mt-2 mx-auto sm:mx-0 translate-y-[20px] lg:translate-x-0 translate-x-[10px]">{subtitle}</p>
  </div>
);
