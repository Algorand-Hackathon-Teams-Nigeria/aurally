...
const UpComingFeatures = () => {
  return (
    <section id="upcoming">
      <h2 className="text-5xl md:text-6xl lg:text-8xl text-center md:text-start leading-relaxed bg-gradient-to-b from-secondaryPink to-secondaryYellow text-transparent bg-clip-text font-bold">
