...
const ApprovedNFTMarketplace: React.FC<NFTMarketplaceProps> = ({ onClose }) => {
  return (
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4 mt-2">
              ...
              <div>
                ...
                <h2 className="text-green-600 text-2xl font-bold">Approved</h2>
              </div>
            </div>
...
export default ApprovedNFTMarketplace;
