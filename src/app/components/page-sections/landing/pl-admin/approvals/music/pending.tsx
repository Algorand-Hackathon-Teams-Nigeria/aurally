// src/app/components/page-sections/landing/pl-admin/approvals/music/pending.tsx
"use client"
...
// 1. Define the props interface **BEFORE** the component function
interface NFTMarketplaceProps {
  onClose: () => void; // Add onClose prop here, it's a function that returns void
}

// 2. Modify the component definition to use React.FC<NFTMarketplaceProps> and destructure onClose from props
const NFTMarketplace: React.FC<NFTMarketplaceProps> = ({ onClose }) => {
  return (
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4 mt-2">
              ...
              <div>
                ...
                <h2 className="text-black text-2xl font-bold">Pending Approval</h2>
              </div>
            </div>

            <div className="flex gap-4 mt-2">
              <button className="px-6 py-3 bg-[#007600] text-white rounded-lg font-medium">Approve</button>
              <button className="px-6 py-3 bg-[#d90429] text-white rounded-lg font-medium">Disapprove</button>
            </div>
          </div>
        </div>
