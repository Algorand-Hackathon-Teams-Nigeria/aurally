...
const faqs = [
  {
    ...
    description:
      "Yes, Aurally is accessible globally, allowing artists and fans from around the world to connect, share, and engage with each other's work.",
  },
  {
    value: "What types of content are allowed on Aurally's platform?",
    description:
      "Aurally welcomes a diverse range of creative content, including music, visual art, videos, podcasts, and more. We encourage artists and creators from all backgrounds and genres to share their unique perspectives and talents with our global audience.",
  },
];
...
const faqs2 = [
  {
    ...
    description:
      "All wallets that have support for the algorand Blockchain. Ẹ.g Pera wallet, Defly wallet.",
  },
  {
