  ...
  return (
    <div className="relative flex justify-center mb-9 lg:translate-y-[-50px] translate-y-[-50px] lg:translate-x-[0px] translate-x-[-24px]">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white">
        ...
        <p className="text-sm text-gray-300 block sm:hidden mt-4 translate-y-[30px] translate-x-[-50px]">
        Take control of your music career with <span className="block ">Aurally&apos;s artist-centric platform.</span>
        </p>
