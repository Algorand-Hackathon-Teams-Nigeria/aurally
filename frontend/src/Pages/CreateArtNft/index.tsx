...
const CreateArtNft = () => {
  ...
  return (
    ...
    >
      <fieldset
        className={!creative ? "pointer-events-none opacity-60" : ""}
        disabled={!creative}
      >
          ...
          <div>
            ...
            <div>
              <div className="text-sm opacity-70">
                File types supported: JPG, PNG, GIF, Max size: 5 MB
              </div>
            </div>
          </div>
          <Dropzone
          ...
          >
            <div className=" pointer-events-none py-10">
              ...
              <Text ta="center" fz="sm" mt="xs" c="dimmed">
                Drag&apos;n&apos;drop files here to upload. Files must be less
                than 3mb in size.
              </Text>
            </div>
          </Dropzone>
