...
const ArtDetails = () => {
  ...
  const filteredArt = nftList.filter((item) => item.id === Number(artId))[0]
  return (
    <div className="routePage">
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-14">
        <div className="h-[75vw] lg:h-[35vw] max-h-[500px] rounded-[10px] overflow-hidden">
          <Image src={filteredArt.imgUrl} className="h-full object-top object-cover" />
        </div>
        <div className="flex flex-col justify-end">
          <div className="py-5 lg:py-8 px-4 lg:px-6 border border-[#444444]">
            <div className="text-[#919191]">Price</div>
            <div className="p-4 sm:p-6 rounded-[10px] bg-[#1E1E1E] mb-6 mt-1">{filteredArt.price} ALGO</div>
      ...
      <div className="gboard mt-6 mb-[90px] min-h-[434px]">
        ...
        {type === 0 ? (
          <div>
            <div className="pt-4 pb-8">{filteredArt.desc}</div>
